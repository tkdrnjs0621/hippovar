...
if __name__=="__main__":
    ...
    parser.add_argument("--save_path", type=str, default="inference/subset_300_prompt_change_v1/context_conversion", help="path to inference data to evaluate (e.g. inference/baseline/zero_v1/Llama-3.1-8B-Instruct)")
    ...
    parser.add_argument("--max_tokens", type=int, default=1000, help="generation config; max new tokens")
