...
if __name__=="__main__":
    ...
    parser.add_argument("--save_path", type=str, default="inference/musique_ans/question_decomposition_raw", help="path to inference data to evaluate (e.g. inference/baseline/zero_v1/Llama-3.1-8B-Instruct)")
    ...
    dataset = load_dataset('json', data_files=args.dataset_path)["train"]#.select(range(300))
